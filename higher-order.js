...
let ordersTotal = orders.map((element) => {element['price'] + element['tax']})
...
let bobsTotal = purchases.filter((element) => element.owner === 'Bob').map((element) => element['price']).reduce((a, b) => a + b)
bobsTotal
